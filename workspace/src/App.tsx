...
function GameView({
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-[#04150d] flex flex-col">
      {/* top HUD bar — keeps all indicators above the field */}
      <div className="relative z-20 shrink-0 w-full flex items-center justify-between gap-2 px-2 pt-2 pb-1.5 sm:pt-3 sm:pb-2">
